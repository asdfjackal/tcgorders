defmodule TCGOrdersWeb.ProjectLive.Show do
  ...
  @impl true
  def handle_info(
        {:updated, %TCGOrders.Projects.Project{id: id} = project},
  ...
  def handle_info(
        {:deleted, %TCGOrders.Projects.Project{id: id}},
        %{assigns: %{project: %{id: id}}} = socket
      ) do
    {:noreply,
     socket
  ...
  def handle_info({type, %TCGOrders.Projects.Project{}}, socket)
